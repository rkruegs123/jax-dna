...
def run(
...
) -> tuple[jd_traj.Trajectory | list[jax_md.rigid_body.RigidBody], dict[str, Any]]:
    ...
    _, trajectory = input_config["scan_fn"](simulation_step_fn, init_state, jnp.arange(input_config["n_steps"]))
