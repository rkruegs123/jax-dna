...
from jax_md import rigid_body, space, util
...
def compute_mean_structure(traj_states):
    ...
    for nt_idx in range(n_nt):
        ...
        alpha, beta, gamma = trajectory.principal_axes_to_euler_angles(
            back_base_vector, onp.cross(base_normal, back_base_vector), base_normal
        )
...
class TestRMSE(unittest.TestCase):
    ...
    def test_rmse(self):
        ...
        test_cases = [(self.test_data_basedir / f"simple-helix", model1.com_to_hb)]
