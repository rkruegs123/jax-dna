...
def loss(
    ...
    residual = extensions - extensions_calc
    return residual
...
if __name__ == "__main__":
    ...
    print(f"Fit values:")
    print(f"- L0 = {res[0] * jd_units.NM_PER_OXDNA_LENGTH} nm")
    print(f"- Lp = {res[1] * jd_units.NM_PER_OXDNA_LENGTH} nm")
    print(f"- K = {res[2] * jd_units.PN_PER_OXDNA_FORCE} pN")
