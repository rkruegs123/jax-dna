...
def energy_fn_factory(displacement_fn,
    ...
    fixed_hb_param_keys = [
        ...
        "theta0_hb_1", "delta_theta_star_hb_1", "delta_theta_hb_1_c", "b_hb_1",
        "theta0_hb_2", "delta_theta_star_hb_2", "delta_theta_hb_2_c", "b_hb_2",
        "theta0_hb_3", "delta_theta_star_hb_3", "delta_theta_hb_3_c", "b_hb_3",
        "theta0_hb_4", "delta_theta_star_hb_4", "delta_theta_hb_4_c", "b_hb_4",
        "theta0_hb_7", "delta_theta_star_hb_7", "delta_theta_hb_7_c", "b_hb_7",
        "theta0_hb_8", "delta_theta_star_hb_8", "delta_theta_hb_8_c", "b_hb_8"
    ]
    ...
    def _compute_subterms(body: RigidBody, seq: util.Array, params, op_nbrs_idx):
        ...
        gc_params = params[0, :] # params is 2x6
        at_params = params[1, :]
