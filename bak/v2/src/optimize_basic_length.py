...
def run(args, init_params,
    ...
    run_name = f"optimize_basic_length_{timestamp}_lr{lr}_n{n_steps_per_force}_s{sample_every}_e{n_eq_steps}_d{target_pdist}_f{ext_force_magnitude}_k{args['key']}"
