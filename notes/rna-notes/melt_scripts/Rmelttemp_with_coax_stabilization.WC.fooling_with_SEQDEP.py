...
hstackDG = DATAFILEPATH + 'coaxial.dat'
hstackDH = DATAFILEPATH + 'coaxial.dh'
...
IntMis_dS_avg, IntMis_dH_avg = get_avg_all_mis_HS() 
...
for key in IntMis_dS_avg.keys():
	...
	DH += IntMis_dH_avg[key]
	DS += IntMis_dS_avg[key]

	 
	#Extra contribution due to 5' overhand
	#DH_5 =  0.6
	#DS_5 =  2.6875
