...
hstackDG = DATAFILEPATH + 'tstack.dat'
hstackDH = DATAFILEPATH + 'tstack.dh'
...
if len(sys.argv) < 3:
	print 'Usage: ./program seqLENGTH(including mismatch)  box'
	sys.exit(1)
...
mismatch = 1
stemlength = int(sys.argv[1]) - mismatch -1
box = 20.
...
s,comp = GenRanMis(stemlength+mismatch+1,mismatch)
