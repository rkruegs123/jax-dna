...
#print (DHavg * 1000  - (273.15 + 37)* DSavg) / 1000
import numpy as np
...
print 'now'
mtdh =  loopDH[looplength] 
mtds = -( loopDG[looplength] - loopDH[looplength])*1000.0/(273.15 + 37) 
print mtdh,mtds
print 'Dg_60 for bulge is ', mtdh - (273.15 + 60) *mtds/1000.
