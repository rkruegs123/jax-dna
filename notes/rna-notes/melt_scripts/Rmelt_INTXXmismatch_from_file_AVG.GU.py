...
if len(sys.argv) < 3:
	print 'Usage: ./program seqLENGTH [no_of_consecutive_mismatches] box'
	sys.exit(1)
...
if(mismatch <= 2):
	print "This is only for more than 3 mismatches. Use other script "
	sys.exit(1)

looplength = mismatch * 2

stemlength = int(sys.argv[1]) - mismatch -1-1
box = 20.
...
s,comp = GenRanMMis(stemlength+mismatch+1+1,mismatch)
