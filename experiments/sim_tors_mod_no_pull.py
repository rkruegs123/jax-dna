...
def run(args):
    ...
    quartets = quartets[5:n_bp-6]

    bp1_meas = [5, strand2_end-5]
    bp2_meas = [strand1_end-5, strand2_start+5]
...
def get_parser():
    ...
    parser.add_argument('--sys-basedir', type=str, default="data/templates/tors-mod-20bp",
                        help='Run name')
