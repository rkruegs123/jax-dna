...
def run(args):
    ...
    par_path = sys_basedir / "protein.par"
    ...
    def get_ref_states(params, i, iter_key, init_body):
        ...
        if write_traj:
            ...
            traj_info.write(iter_dir / "sampled_states.dat", reverse=False)
    ...
    dna_base_protein_sigma, dna_base_protein_epsilon, dna_base_protein_alpha, dna_back_protein_sigma, dna_back_protein_epsilon, dna_back_protein_alpha = model_nbrs.get_init_morse_tables()
    ...
    for i in tqdm(range(n_iters)):
        ...
        if n_eff < min_n_eff or num_resample_iters >= max_approx_iters:
            ...
            start = time.time()
            ref_states, ref_energies, unweighted_rmses, ref_iter_dir = get_ref_states(
                params,
                i=i,
                iter_key=split,
