...
def run(args):
    ...
    @jit
    def loss_fn(params, ref_states: rigid_body.RigidBody, ref_energies, ref_ptwists, temp):
    ...
    ref_states, ref_energies, ref_ptwists = get_ref_states(params, init_body, key, 0, temp=gumbel_temps[0])
