...
reparam_dir = data_dir / "reparam"

target_dir = reparam_dir / f"t{target_pitch}"
...
for width, height in [(16, 10), (14, 10), (12, 10)]:
    ...
    y_vals = [10.6, 10.7, 10.8, 10.9, 11.0]
    ax.set_yticks(y_vals)
    ax.set_yticklabels([r'$10.6$', r'$10.7$', r'$10.8$', r'$10.9$', r'$11$'])
    ...
    # plt.show()
    plt.savefig(output_dir / f"reparam_pitch_{width}_{height}.pdf")
