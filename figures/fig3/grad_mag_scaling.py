...
grad_mag_data_dir = data_dir / "grad-scaling-difftre"

length_path = grad_mag_data_dir / "log/length.txt"
lengths = onp.loadtxt(length_path)
mean_grad_abs_path = grad_mag_data_dir / "log/mean_grad_abs.txt"
mean_grad_abs = onp.loadtxt(mean_grad_abs_path)

fig, ax = plt.subplots(figsize=(12, 10))

ax.plot(lengths, mean_grad_abs, color="black", linewidth=2)
