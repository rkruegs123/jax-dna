...
duplex_opt_dir = data_dir / "duplex/oxdna1/t310/all"
hairpin_opt_dir = data_dir / "hairpin/s0.25/t332/all"
...
for t_name, t_dir in [("duplex_oxdna1_t310", duplex_opt_dir), ("hairpin_oxdna2_s025_t332", hairpin_opt_dir)]:
    ...
    grads_path = t_dir / "log/grads.txt"
    ...
    for width, height in sizes:
        ...
        # plt.show()
        plt.savefig(output_dir / f"{t_name}_top{m}_grads_{width}x{height}.pdf")
        # plt.savefig(output_dir / f"{t_name}_top{m}_grads_{width}x{height}.svg")
