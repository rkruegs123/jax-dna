...
for width, height in [(20, 14), (24, 14), (28, 14)]:
    ...
    fin_tms_path = tm_dir / "obj/fin_tms.npy"
    fin_tms = onp.load(fin_tms_path)[:max_iter]

    fin_ref_iters_path = tm_dir / "obj/fin_ref_iters.npy"
    fin_ref_iters = onp.load(fin_ref_iters_path)

    fin_ref_tms_path = tm_dir / "obj/fin_ref_tms.npy"
    ...
    ax.axhline(y=332, linewidth=3, linestyle="--", color="red", label="Target")
    ...
    # plt.show()
    plt.savefig(output_dir / f"tm_hairpin_{width}x{height}.pdf")
